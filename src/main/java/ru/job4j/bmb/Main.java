...
public class Main {
    ...
    CommandLineRunner loadDatabase(MoodRepository moodRepository,
        ...
        return args -> {
            ...
            List<Mood> savedMoodList = initMoods(moodRepository);
            initMoodContents(moodContentRepository, savedMoodList);
    ...
    private List<Mood> initMoods(MoodRepository moodRepository) {
        ...
        return savedMoodList;
    }

    private void initMoodContents(MoodContentRepository moodContentRepository, List<Mood> savedMoodList) {
